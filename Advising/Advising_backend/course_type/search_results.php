...
<?php
    ...
    $query = "SELECT * FROM CourseType WHERE $searchType LIKE ?";
    ...
    for($i=0; $i<$num_results; $i++){ 
        ...
        echo "<br />";
        echo "CourseType Name ".stripslashes($row['courseTypeName']);
        echo "<br />";
        echo "CourseType Abbreviation: ".stripslashes($row['CoAbbreviation']);
        echo "<br />";
